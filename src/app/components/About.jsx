...
const About = () => {
  return (
    <div id="about" className="bg-warmGray-950 flex flex-col items-center w-full px-4 py-8 mb-8">
        <div className="max-w-[1024px] flex flex-col items-center w-full sm:w-4/6">
          ...
          <p className="mb-8">
              HemanHill manufacturers two lines of furniture that are designed to create a unique style for your gallery. The French Country and Italian Country lines are made from old Barnwood. The Live Edge line is made from reclaimed trees, both lines are environmentally accurate, finished in water based paint and polyurethane. The hardware is hand made by a blacksmith in Santa Barbara.
          </p>
          <p className="mb-8">
