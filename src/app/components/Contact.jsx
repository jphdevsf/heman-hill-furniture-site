...
const Contact = () => {
  return (
    <div
      id="contact"
      className="bg-warmGray-1000 max-w-[1440px] rounded-lg overflow-hidden mx-auto w-11/12 md-w-full flex flex-col-reverse md:flex-row mb-10"
    >
      <div className="w-full h-48 md:h-auto md:w-7/12 mb-4 md:mb-0 flex flex-col justify-center items-center">
        ...
        <a href="mailto:hemanhill@yahoo.com" className="text-white underline mb-6 md:mb-0">
          hemanhill@yahoo.com
        </a>
      </div>
